...
%error('was there a rotation in the code ??')
%% input
% jsonPath =[];
...
MAIN_PATH='F:\simulation_xray_kk\sim1_noise_10000_phase_1e-05_abs_1e-06';name='\SIM_8333.000';percent_cropp=1;norotation=true;
