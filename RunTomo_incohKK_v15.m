...
[fourier_position,fourier_intensity,dark_position]=cut_off_analysis_general_v2(cutoff_file,val.start,val.step,false);
% {
selection=25:70;
...
for offset=possible_val;
    ...
    [tomoOut, Eout, DPCdata] = sino2tomo(gpuArray(rawSino_rec), angleLib(validAngInd), 0, bgWingSize, fieldReconInputParams, true,rawSino_rec(:,:,1)*0+1);
